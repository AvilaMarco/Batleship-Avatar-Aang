...
const viewClientData = ({name, score, nation, user_type}) => {
  ...
  playerCard.querySelector("[data-player]").classList.add(`${user_type.toLowerCase()}-player`)
  playerCard.querySelector("[data-bg-nation]").src = `assets/icons/border-${nation}.png`
  playerCard.querySelector("[data-logo-nation]").src = `assets/icons/select-${nation}.png`
